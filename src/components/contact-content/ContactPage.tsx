...
export default function ContactPage() {
  ...
  return (
    <section className=" flex justify-center items-center bg-gray-100 p-4 w-[80%] max-w-screen-2xl rounded-[30px] md:rounded-[50px] mt-10">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col md:grid md:grid-cols-2 gap-6">
          ...
          <div>
            ...
            <input
              ...
              className="w-full py-4 2xl:py-6 px-9 rounded-full text-black border focus:outline-none focus:ring-2 focus:ring-red-500"
            />
          ...
          <div className="col-span-2">
            ...
            <textarea
              ...
              rows={5}
              className="w-full py-4 2xl:py-6 px-9 border rounded-2xl text-black focus:outline-none focus:ring-2 focus:ring-red-500"
            ></textarea>
          ...
          <Button
            type="submit"
            variant={'destructive'}
            className="w-44 text-white text-2xl font-bold !py-7 px-6 rounded-full transition-all duration-300"
          >
            Send
